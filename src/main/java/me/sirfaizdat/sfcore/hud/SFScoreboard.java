...
package me.sirfaizdat.sfcore.hud;

import com.google.common.base.Preconditions;
import com.google.common.base.Splitter;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import me.sirfaizdat.sfcore.SFCore;
...
/**
 * SFScoreboard allows for easy creation of scoreboards.
...
public class SFScoreboard {
    ...
    /**
     * Creates a new SFScoreboard with a title.
     *
     * @param title The title of this board (color codes supported).
     */
    public SFScoreboard(String title) {
        this.scoreboard = Bukkit.getScoreboardManager().getNewScoreboard();
        this.title = SFCore.color(title);
