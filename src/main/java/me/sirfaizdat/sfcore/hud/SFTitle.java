...
public class SFTitle {
     ...
     */
    public SFTitle(String title, String subtitle) {
        this.title = title;
     ...
     */
    public SFTitle(String title, String subtitle, int fadeInTime, int stayTime,
                   int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
